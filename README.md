...
* Or if you're having trouble with Homebrewery etc etc, you can just [download the PDF in this repo](Volos-Waterdeep-Enchiridion-small.pdf). Please note some 1-column wide images were shrunk to fit under GitHub's 25mb filesize limit. I have not tested printing it, hopefully the difference is not noticeable.
...
* All images are [saved locally in the assets-enchiridion directory](assets-enchiridion) to avoid any future broken links etc.
